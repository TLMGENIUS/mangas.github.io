...
(() => {
    ...
    window.__wm = {
      ...
      bt: function (e, t, s, n, i, a, r, c, h, u, d) {
        ...
        function J() {
          const e =
            W("donato").offsetHeight +
            (W("wm-ipp-inside").offsetHeight - W("wm-capinfo").offsetHeight);
        ...
        (te.onmouseenter = se),
          ...
          (te.onmousemove = function (t) {
            ...
            if (((W("wm-graph-anchor").href = C), L != m)) {
              var M = m * s;
              (x.style.left = M + "px"), (L = m);
            }
            if (E != v) {
              var T = m + v * n + 1;
              (H.style.left = T + "px"), (E = v);
            }
          });
              ...
              .then((e) => {
                ...
                if ("success" == t && s?.length > 0)
                  try {
                    ...
                    re.appendChild(e), o(() => re.appendChild(t)), Y(!0);
                  } catch (e) {
                    console.error(
